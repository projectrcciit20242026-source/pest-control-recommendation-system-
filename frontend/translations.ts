...
export const TRANSLATIONS: Record<Language, TranslationContent> = {
  english: {
    ...
    brand: "AgriGuard",
    brand_desc: "Pest Detection & Recommendation System",
  ...
  bangla: {
    ...
    brand: "এগ্রিগার্ড",
    brand_desc: "আইওটি-ভিত্তিক কীটপতঙ্গ ও মাটি পর্যবেক্ষণ ব্যবস্থা",
    ...
    tipBody:
      "উন্নত নির্ভুলতার জন্য ছবিটি পরিষ্কার এবং পর্যাপ্ত আলোতে আছে তা নিশ্চিত করুন। পোকা বা ক্ষতিগ্রস্ত এলাকার দিকে নজর দিন।",
    scan: "স্ক্যান",
    history: "ইতিহাস",
    settings: "সেটিংস",
